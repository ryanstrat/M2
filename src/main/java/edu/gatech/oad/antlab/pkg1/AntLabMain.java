 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Ryan Strat");
		  toPrint += p1.toString("rstrat6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Gregory Cooke");
		  toPrint += p2.toString("gcooke3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Tiera Lee");
		  toPrint += p3.toString("tlee320");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Thomas Light");
                  toPrint += p4.toString("tlight6");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Kanan Patel");
                  toPrint += p5.toString("kpatel342");
